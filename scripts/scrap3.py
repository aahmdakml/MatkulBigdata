...
class BeritaPanganScraperEnhanced:
    ...
    def extract_price_info(self, text):
        """Ekstrak informasi harga dari teks dengan lebih detail"""
        prices = []
        
        # Pattern lebih komprehensif
        price_patterns = [
    ...
    def run_scraping(self, max_pages_per_site=20, use_google_news=True):
    ...
    def save_to_csv(self, filename='harga_pangan_jabar_enhanced.csv'):
        ...
        with open(filename, 'w', newline='', encoding='utf-8') as f:
            fieldnames = [
                ...
                'prices', 'locations_general', 'locations_kota', 'locations_kabupaten',
